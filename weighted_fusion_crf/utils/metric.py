...
from utils.reader_utils import get_ner_reader, extract_spans
...
class SpanF1(Metric):
    ...
    def get_metric(self, reset: bool = False) -> float:
        ...
        if len(all_tags) == 0:
            temp = 1
        all_metrics["macro@P"] = macro_precision/temp
        all_metrics["macro@R"] = macro_recall/temp
        all_metrics["macro@F1"] = macro_f1_measure/temp
